...
(library Library_1
	...
	(compDef "TMUX1204DGSR" (originalName "TMUX1204DGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "10" (pinName "A1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(compPin "6" (pinName "VDD") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Power))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/TMUX1204")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TMUX1204DGSR.stp")
